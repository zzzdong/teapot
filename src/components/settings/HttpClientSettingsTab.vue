    ...
    >
      ...
      >
        <div v-if="form.caCertPaths && form.caCertPaths.length > 0">
          <div
            v-for="(path, index) in form.caCertPaths"
            :key="index"
            class="cert-path-item"
          >
            <n-input
      ...
      <n-form-item
        v-if="form.proxy.enabled"
        label="代理主机"
        path="proxy.host"
      >
        <n-input
          v-model:value="form.proxy.host"
